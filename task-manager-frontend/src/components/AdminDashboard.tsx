      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">Manage and monitor all users in the system</p>
          </div>
          <Link
            to="/dashboard"
            ...
            <div className="bg-white rounded-lg max-w-md w-full p-6 transform transition-all">
              ...
              <div className="mb-4">
                <p className="text-sm text-gray-500">
                  Are you sure you want to delete the user <span className="font-medium text-gray-900">{userToDelete.username}</span>? This action cannot be undone.
                </p>
              </div>
